...
#  for temp in T_UTS:
  ...
  mat.Expansion(table=zip(V_Exp, T_Exp), temperatureDependency=ON)

def createStainlessSteelMaterialProperty(name, density, PoissonR, (V_E, T_E), (V_Exp, T_Exp), (V_Y, T_Y), (V_UTS, T_UTS)):
  """function to define material property based on ASME II Part D"""
  mat = model.Material(name=name)
  mat.Density(table=((density, ), ))
  PoissonList = [PoissonR for i in range(len(V_E))]
...
T_UTS = [40.,   100,   150.,  200.,  250.,  300.,  325.,  350.,  375.,  400.,  425.,  450.,  475.,  500.,  525.]
V_UTS = [331E6, 331E6, 331E6, 331E6, 331E6, 331E6, 331E6, 331E6, 331E6, 326E6, 306E6, 282E6, 255E6, 227E6, 203E6]
createCarbonSteelMaterialProperty(name, density, PoissonR, (V_E, T_E), (V_Exp, T_Exp), (V_Y, T_Y), (V_UTS, T_UTS))
...
createStainlessSteelMaterialProperty(name, density, PoissonR, (V_E, T_E), (V_Exp, T_Exp), (V_Y, T_Y), (V_UTS, T_UTS))




name = 'SA-240 Grade-316'
density = 8000.
PoissonR = 0.3
...
createCarbonSteelMaterialProperty(name, density, PoissonR, (V_E, T_E), (V_Exp, T_Exp), (V_Y, T_Y), (V_UTS, T_UTS),temps=[-10.,55.])
