...
###
                    ...
                    # The following function call must be moved out of the recursive loop!
                    # Sps only depends on the material, it must be a list where the value is picked from
                    Sps         = calcSps(Smaxt, SYt, UTSt)                             # Paragraph 5.5.6.1 d)

                    Kek         = [calcKek(Spk[n], Sps, m_fatigue, n_fatigue, ) for n in range(len(S_element))]     # Fatigue penalty factor, Eqs (5.31) to (5.33) 
                    if max(Kek) > 1:
                    ...
                    damageBottom    = elementDamage2017(s1, Et/1E6, materialName, UTSt/1E6) 
                    damageTop       = elementDamage2017(s2, Et/1E6, materialName, UTSt/1E6)
                    ...
                    damage = elementDamage2017(Sa, Et/1E6, materialName, UTSt/1E6)
